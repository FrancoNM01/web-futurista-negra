const contentByTab = {
  servicios: {
    kicker: "Más consultas",
    title: "Mostrá lo que hacés y llevá clientes directo a WhatsApp.",
    text: "Ideal para negocios locales, profesionales, estética, servicios, cursos, técnicos y marcas personales.",
    cta: "Pedir mi página",
    image: "https://images.unsplash.com/photo-1497366754035-f200968a6e72?auto=format&fit=crop&w=1200&q=80",
  },
  tienda: {
    kicker: "Vender online",
    title: "Mostrá tus productos y facilitá los pedidos por WhatsApp.",
  ...
  reservas: {
    ...
    title: "Hacé que tus clientes puedan pedir turno de forma simple.",
    text: "Ideal para estética, barberías, bienestar, fotógrafos, entrenadores y servicios por agenda.",
  ...
  portfolio: {
    ...
    title: "Transformá tus trabajos en prueba de confianza.",
    text: "Pensada para barberías, estética, construcción, arquitectura, diseño, fotografía y servicios visuales.",
  ...
  blog: {
    ...
    text: "Sumamos beneficios, preguntas frecuentes, reseñas y textos claros para que tu negocio se vea profesional.",
